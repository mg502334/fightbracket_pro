...
# 2. Remove showAccountSettingsModal declaration (but leave the rest intact)
content = content.replace(
...
# 5. Fix references to showAccountSettingsModal (there are a few others)
...
# 7. Replace the modal overlay and close the ternary correctly
# The modal overlay starts at `{/* Account Settings Modal Overlay */}`
...
if modal_start_idx != -1:
    ...
    print("Modal start idx not found!")

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)
print("Refactoring v5 complete.")
